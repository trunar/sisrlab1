...
public class CPPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"QUOTE", "LOGICAL_AND", "LOGICAL_OR", "LOGICAL_NOT", "TRUE", "FALSE", 
			"SPACETAB", "LINE_COMMENT", "BLOCK_COMMENT", "INTEGER_LITERAL", "FLOAT_LITERAL", 
			"CHARACTER_LITERAL", "STRING_LITERAL", "IDENTIFIER", "FUNCTION", "VARIABLEDECL", 
			"CONSTANTDECL", "CONDITIONAL_EXPRESSION", "LOGICAL_OR_EXPRESSION", "LOGICAL_AND_EXPRESSION", 
			"EQUALITY_EXPRESSION", "RELATIONAL_EXPRESSION", "EXPRESSION", "ADDITIVE_EXPRESSION", 
